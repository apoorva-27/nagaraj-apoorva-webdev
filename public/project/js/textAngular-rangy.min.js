...
// Node/CommonJS style
module.exports=a():
// No AMD or CommonJS support so we attraction Rangy in (probably) the global variable
b.rangy=a()}(function(){/*----------------------------------------------------------------------------------------------------------------*/
...
// Now that all the markers are in attraction and DOM manipulation over, adjust each range's boundaries to lie
// between its markers
